<?php
    ...
    if(isset($_GET['id']) && is_numeric($_GET['id']) && $_GET['id'] > 0){
        ...
        if($openedRow){
            ...
            $systemMessage = "Sticker was not found!!!";
        }
    }else {
    ...
    if($status){
        ...
        if (isset($formData["submit"]) && $formData["submit"] == "Yes, delete") {
            ...
            $deleteStatus = deleteSticker($connection, $stickerId);
            if($deleteStatus){
                $systemMessage = "Sticker successfully deleted!!!";
            } else{
    ...
    include_once '../../../views/stickers/deleteView.php';
